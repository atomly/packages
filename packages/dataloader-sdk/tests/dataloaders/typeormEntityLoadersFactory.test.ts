...
// Dependencies
import {
  DefaultEntityLoadersFactory,
  TypeORMDataAdapter,
  TypeORMDataAdapterOptions,
} from '../../src';
import {
...
const LIMITED_TEST_ENTITITIES_AMOUNT = 10;
...
const testEntity1Loader = new DefaultEntityLoadersFactory<
  ...
  TestEntity1,
  TypeORMDataAdapterOptions<TestEntity1>
>({
  entity: TestEntity1,
  entityReferenceIdKeys: ETestEntity1ReferenceKeys,
  ...
  dataAdapter: new TypeORMDataAdapter(),
});
...
>({
  entity: TestEntity2,
  entityReferenceIdKeys: ETestEntity2ReferenceKeys,
  dataAdapter: new TypeORMDataAdapter(),
});
...
>({
  entity: TestEntity4,
  entityReferenceIdKeys: ETestEntity4ReferenceKeys,
  entityReferenceIdKeysParams: {
    testEntity3Id: {
...
describe('DefaultEntityLoadersFactory works correctly', () => {
   ...
   * TODO:
   * 
   * Test `entityReferenceIdKeysParams` parameters are being
   * correctly passed down, and used by their respective consumers.
   * 
   * ```
   *    const testEntity1Loader = new DefaultEntityLoadersFactory<
   *      ETestEntity1ReferenceKeys,
