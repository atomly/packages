...
function onHelp(): void {
  ...
  console.info('  $ ./cli.js models -n beast_test -o ./tmp/output');
  console.info('  $ ./cli.js generate -n beast_dev -c ./config -cli ./node_modules/typeorm/cli.js');
  console.info('  $ ./cli.js run -n beast_prod');
}
...
program
  .version('1.0.0')
  .name('beast-entities-migrations')
  .description('Beast TypeORM migrations service.')
