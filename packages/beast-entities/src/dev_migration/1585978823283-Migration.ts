...
export class Migration1585978823283 implements MigrationInterface {
    name = 'Migration1585978823283'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."teams_members_members" ADD CONSTRAINT "PK_bb97ce06820e3e5681f1cf6456e" PRIMARY KEY ("members")`, undefined);
        await queryRunner.query(`ALTER TABLE "public"."teams_members_members" DROP COLUMN "teams"`, undefined);
        await queryRunner.query(`ALTER TABLE "public"."teams_members_members" DROP CONSTRAINT "PK_bb97ce06820e3e5681f1cf6456e"`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "public"."teams_members_members" ADD CONSTRAINT "PK_abf5fdd20df70598d60dd67cd6d" PRIMARY KEY ("teamsId")`, undefined);
        await queryRunner.query(`ALTER TABLE "public"."teams_members_members" ADD "membersId" integer NOT NULL`, undefined);
        await queryRunner.query(`ALTER TABLE "public"."teams_members_members" DROP CONSTRAINT "PK_abf5fdd20df70598d60dd67cd6d"`, undefined);
